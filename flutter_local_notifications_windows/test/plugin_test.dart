...
const WindowsInitializationSettings goodSettings = WindowsInitializationSettings(
  appName: 'test',
...
void main() => group('Plugin', () {
      ...
      test('cannot be used before initializing', () async {
        final FlutterLocalNotificationsWindows plugin = FlutterLocalNotificationsWindows();
        final WindowsProgressBar progress = WindowsProgressBar(id: 'progress', status: 'Testing', value: 0);
