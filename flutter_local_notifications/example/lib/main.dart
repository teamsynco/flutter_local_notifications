...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _showMessagingNotification() async {
    ...
    final NotificationDetails notificationDetails = NotificationDetails(android: androidNotificationDetails);
    await flutterLocalNotificationsPlugin.show(id.toString(), 'message title', 'message body', notificationDetails);
  ...
  Future<void> _showProgressNotification() async {
    ...
    for (int i = 0; i <= maxProgress; i++) {
      await Future<void>.delayed(const Duration(seconds: 1), () async {
        ...
        final NotificationDetails notificationDetails = NotificationDetails(android: androidNotificationDetails);
        await flutterLocalNotificationsPlugin.show(
            progressId.toString(), 'progress notification title', 'progress notification body', notificationDetails,
            payload: 'item x');
      });
    }
  }
  ...
  Future<void> _getActiveNotificationMessagingStyle(String id, String? tag) async {
