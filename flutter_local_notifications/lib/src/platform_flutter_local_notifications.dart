...
class MethodChannelFlutterLocalNotificationsPlugin extends FlutterLocalNotificationsPlatform {
  @override
  Future<void> cancel(String id) => _channel.invokeMethod('cancel', id);
...
class AndroidFlutterLocalNotificationsPlugin extends MethodChannelFlutterLocalNotificationsPlugin {
  ...
  Future<void> startForegroundService(String id, String? title, String? body,
      {AndroidNotificationDetails? notificationDetails,
      String? payload,
    ...
    switch (call.method) {
      case 'didReceiveNotificationResponse':
        _onDidReceiveNotificationResponse?.call(
          NotificationResponse(
            id: call.arguments['notificationId']?.toString(),
